            ...
            <div className="card auth-card">
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <Link href="/" className="navbar-brand" style={{ justifyContent: 'center' }}>
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ color: 'var(--accent)' }}>
                ...
                <p className="auth-subtitle">Sign in to your Cloud Fragment account</p>
                ...
                <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
                    ...
                    <Link href="/register" className="auth-link">Sign up free</Link>
                </p>
            </div>
        </div>
    )
